...
class MCSimulation:
    ...
    def __init__(self, portfolio_data, weights="", num_simulation=1000, num_trading_days=252):
        ...
        if weights == "":
            num_stocks = len(portfolio_data.columns)
        ...
        close_df = portfolio_data.pct_change()
    ...
    def calc_cumulative_return(self):
        ...
        last_prices = self.portfolio_data[:-1].iloc[-9].tolist()
        ...
        mean_returns = self.close_df.mean().tolist()
        std_returns = self.close_df.std().tolist()
    ...
    def plot_simulation(self):
        ...
        plot_title = f"{self.nSim} Simulations of Returns Paths for the Next {self.nTrading} Trading Days"
